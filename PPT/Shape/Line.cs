...
namespace PowerPoint
{
    public class Line : Shape
    {
        ...
        public Line()
        {
            ShapeType = Constant.SHAPE_TYPE_LINE_CHINESE;
        }
        ...
        {
            graphics.DrawLine(ConvertCoordinate(StartPoint.X, scaleX), ConvertCoordinate(StartPoint.Y, scaleY), ConvertCoordinate(EndPoint.X, scaleX), ConvertCoordinate(EndPoint.Y, scaleY));
            if (IsSelect)
            {
