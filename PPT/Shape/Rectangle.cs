...
namespace PowerPoint
{
    public class Rectangle : Shape
    {
        ...
        private double _rightDownY; private double _startPointX
        {
            get
            {
                return StartPoint.X;
        ...
        public Rectangle()
        {
            ShapeType = Constant.SHAPE_TYPE_RECTANGLE_CHINESE;
        }
        ...
        public override void Draw(IGraphics graphics, double scaleX, double scaleY)
        {
            ...
            {
                graphics.DrawRectangle(ConvertCoordinate(StartPoint.X, scaleX), ConvertCoordinate(StartPoint.Y, scaleY), ConvertCoordinate(EndPoint.X, scaleX), ConvertCoordinate(EndPoint.Y, scaleY));
                if (IsSelect)
                {
